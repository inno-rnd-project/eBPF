    ...
    "definitions": {
        ...
        "internal_correlation_api.NodeResponse": {
            ...
            "properties": {
                ...
                "status_basis": {
                    "description": "StatusBasis 는 status 등급을 결정한 신호다 (#324, pressure / health / alert). 등급 동률이면\npressure, health, alert 순으로 귀속하며 status 가 unknown (신호 전부 부재) 이면 생략된다.",
                    "type": "string"
                },
                "summary": {
                    "type": "string"
