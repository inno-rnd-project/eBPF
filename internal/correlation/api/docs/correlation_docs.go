        ...
        "/api/v1/trends": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "추이 신호 (noisy_neighbor_intensity / noisy_neighbor_count / cross_node_intensity / service_impact_intensity / latency_p99 / drop_rate / bandwidth_rx / bandwidth_tx / pressure_max)",
                        "name": "signal",
                        "in": "query",
                        "required": true
                    },
