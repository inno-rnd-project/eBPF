...
test-prometheus-rules:
	...
	@for t in $(PROMTOOL_TEST_FILES); do \
		...
		docker run --rm --entrypoint promtool \
			...
			-v $(CURDIR)/$(PROMTOOL_RULES_TMP_DIR)/monitoring.yaml:/tmp/monitoring.yaml \
